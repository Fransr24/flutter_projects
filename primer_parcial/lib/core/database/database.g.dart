    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Team` (`id` INTEGER NOT NULL, `country` TEXT NOT NULL, `confederation` TEXT NOT NULL, `worldCups` INTEGER NOT NULL, `isWorldChampion` INTEGER NOT NULL, `flag` TEXT, PRIMARY KEY (`id`))');
